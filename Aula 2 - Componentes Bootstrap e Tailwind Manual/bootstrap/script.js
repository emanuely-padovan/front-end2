...
function criarCardPrato(prato) {
  ...
  card.innerHTML = `
    ...
    <div class="card-footer bg-transparent border-top-0 pb-3">
      <button class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#modalPrato" data-nome="${prato.nome}" data-categoria="${prato.categoria}" data-preco="${prato.formatarPreco()}" data-descricao="${prato.descricao}">Mais Informações</button>
    </div>
  `;
